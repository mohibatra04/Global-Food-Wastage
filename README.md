...
A Python-based data analysis project exploring food waste trends, economic losses, and per-capita wastage data across various countries and food categories.
...
* **Average Global Waste per Capita:** 124.62 Kg
